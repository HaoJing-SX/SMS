...
class DataAugmentor(object):
    def __init__(self, root_path, augmentor_configs, class_names, logger=None):
        ...
        self.logger = logger
        self.aug_config = augmentor_configs
        self.data_augmentor_queue = []
        aug_config_list = augmentor_configs if isinstance(augmentor_configs, list) \
            else augmentor_configs.AUG_CONFIG_LIST
        # print('list1:', aug_config_list)
        # print('list2:', isinstance(augmentor_configs, list)) # False
        # print('list3:', augmentor_configs)
        # for k in augmentor_configs:
        #     print('k:', k)
        ...
        # print('data_augmentor_queue:', self.data_augmentor_queue)
    ...
    def random_world_flip(self, data_dict=None, config=None):
        ...
        # print('point_size3:', len(data_dict['points']))
        # print('gt_boxes_size3:', len(data_dict['gt_boxes']))
        return data_dict
    ...
    def random_world_rotation(self, data_dict=None, config=None):
        ...
        data_dict['gt_boxes'] = gt_boxes
        data_dict['points'] = points
        # print('point_size4:', len(data_dict['points']))
        # print('gt_boxes_size4:', len(data_dict['gt_boxes']))
        return data_dict
    ...
    def random_world_scaling(self, data_dict=None, config=None):
        ...
        data_dict['gt_boxes'] = gt_boxes
        data_dict['points'] = points
        # print('point_size5:', len(data_dict['points']))
        # print('gt_boxes_size5:', len(data_dict['gt_boxes']))
        return data_dict
